...
export function getDefaultThresholds() {
  return {
    ...
    temp_control: { enabled: true, led_threshold: 8, danger_threshold: 15 },
...
export async function getThresholds() {
  if (isConfigured) {
    ...
    return {
      ...
      weight: { enabled: true, low_stock: t.low_stock_weight ?? 500 },
      tvoc: { enabled: true, fan_threshold: t.tvoc_fan_threshold ?? 3, buzzer_threshold: t.tvoc_buzzer_threshold ?? 4 },
      temp_control: { enabled: true, led_threshold: t.temp_led_threshold ?? 28, danger_threshold: t.temp_danger_threshold ?? 30 },
      light: { enabled: true, threshold: t.light_threshold ?? 5 },
    };
  }
