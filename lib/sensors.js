export const SENSORS = [
  ...
  { key: "temperature", name: "Temperature", subtitle: "MKR ENV Shield", unit: "°C", icon: "🌡️", color: "#ff5c5c", bgColor: "rgba(255,92,92,0.1)", lightColor: "#fff0f0", active: true },
  ...
  { key: "weight", name: "Shelf Weight", subtitle: "Load Cell", unit: "g", icon: "⚖️", color: "#00c48c", bgColor: "rgba(0,196,140,0.1)", lightColor: "#e6faf3", active: true },
  { key: "gas", name: "Odor / Gas", subtitle: "TVOC & CO2 Analysis", unit: "mixed", icon: "👃", color: "#8b5cf6", bgColor: "rgba(139,92,246,0.1)", lightColor: "#f3f0ff", active: true },
  { key: "color", name: "Color Value", subtitle: "RGB", unit: "HEX", icon: "🎨", color: "#be4bdb", bgColor: "rgba(190,75,219,0.1)", lightColor: "#f8f0fc", active: true },
];
