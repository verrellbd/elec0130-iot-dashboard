export const SENSORS = [
  ...
  { key: "freshness", name: "Freshness", subtitle: "TCS34725 · RGB Sensor", unit: "", icon: "🎨", color: "#00c48c", bgColor: "rgba(0,196,140,0.1)", lightColor: "#e6faf3", active: true, realtimeStyle: "bignumber", noHistory: true, range: { min: 0, max: 100 } 
},
];
